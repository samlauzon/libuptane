...
static asn_SEQUENCE_specifics_t asn_SPC_SnapshotMetadata_specs_1 = {
	...
	offsetof(struct SnapshotMetadata, _asn_ctx),
...
asn_TYPE_descriptor_t asn_DEF_SnapshotMetadata = {
	...
	asn_DEF_SnapshotMetadata_tags_1,
	sizeof(asn_DEF_SnapshotMetadata_tags_1)
		/sizeof(asn_DEF_SnapshotMetadata_tags_1[0]), /* 1 */
	asn_DEF_SnapshotMetadata_tags_1,	/* Same as above */
	sizeof(asn_DEF_SnapshotMetadata_tags_1)
		/sizeof(asn_DEF_SnapshotMetadata_tags_1[0]), /* 1 */
	0,	/* No PER visible constraints */
	asn_MBR_SnapshotMetadata_1,
	2,	/* Elements count */
	&asn_SPC_SnapshotMetadata_specs_1	/* Additional specs */
};
