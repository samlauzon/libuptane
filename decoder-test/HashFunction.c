...
static asn_INTEGER_enum_map_t asn_MAP_HashFunction_value2enum_1[] = {
	{ 0,	6,	"sha224" },
	{ 1,	6,	"sha256" },
	{ 2,	6,	"sha384" },
	{ 3,	6,	"sha512" },
...
static unsigned int asn_MAP_HashFunction_enum2value_1[] = {
	0,	/* sha224(0) */
	1,	/* sha256(1) */
	2,	/* sha384(2) */
	3,	/* sha512(3) */
...
static asn_INTEGER_specifics_t asn_SPC_HashFunction_specs_1 = {
...
static ber_tlv_tag_t asn_DEF_HashFunction_tags_1[] = {
