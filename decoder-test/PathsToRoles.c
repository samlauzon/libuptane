...
static ber_tlv_tag_t asn_DEF_PathsToRoles_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_PathsToRoles = {
	"PathsToRoles",
	"PathsToRoles",
	SEQUENCE_free,
	SEQUENCE_print,
	...
	asn_DEF_PathsToRoles_tags_1,
	sizeof(asn_DEF_PathsToRoles_tags_1)
		/sizeof(asn_DEF_PathsToRoles_tags_1[0]), /* 1 */
	asn_DEF_PathsToRoles_tags_1,	/* Same as above */
	sizeof(asn_DEF_PathsToRoles_tags_1)
		/sizeof(asn_DEF_PathsToRoles_tags_1[0]), /* 1 */
