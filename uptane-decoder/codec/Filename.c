 ...
 */
static void
Filename_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
Filename_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	Filename_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
Filename_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
Filename_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Filename_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
Filename_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Filename_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_Filename_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (26 << 2))
};
asn_TYPE_descriptor_t asn_DEF_Filename = {
	"Filename",
	"Filename",
	Filename_free,
	Filename_print,
	...
	asn_DEF_Filename_tags_1,
	sizeof(asn_DEF_Filename_tags_1)
		/sizeof(asn_DEF_Filename_tags_1[0]), /* 1 */
	asn_DEF_Filename_tags_1,	/* Same as above */
	sizeof(asn_DEF_Filename_tags_1)
		/sizeof(asn_DEF_Filename_tags_1[0]), /* 1 */
