...
void
UTCDateTime_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	UTCDateTime_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
UTCDateTime_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
UTCDateTime_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UTCDateTime_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
UTCDateTime_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
UTCDateTime_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
asn_TYPE_descriptor_t asn_DEF_UTCDateTime = {
	...
	UTCDateTime_free,
	UTCDateTime_print,
	UTCDateTime_constraint,
	UTCDateTime_decode_ber,
	UTCDateTime_encode_der,
	UTCDateTime_decode_xer,
	UTCDateTime_encode_xer,
	0, 0,	/* No PER support, use "-gen-PER" to enable */
	0,	/* Use generic outmost tag fetcher */
	asn_DEF_UTCDateTime_tags_1,
	sizeof(asn_DEF_UTCDateTime_tags_1)
		/sizeof(asn_DEF_UTCDateTime_tags_1[0]), /* 1 */
	asn_DEF_UTCDateTime_tags_1,	/* Same as above */
	sizeof(asn_DEF_UTCDateTime_tags_1)
		/sizeof(asn_DEF_UTCDateTime_tags_1[0]), /* 1 */
